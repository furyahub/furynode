...
func main() {
	...
	res, err := http.Get("https://api.furynet.finance/ibc/core/channel/v1/channels")
	if err != nil {
		panic(err)
	}
	...
	conRes, err := http.Get("https://api.furynet.finance/ibc/core/connection/v1/connections")
	if err != nil {
		panic(err)
	}
...
func GetClientState(clientID string) ClientResponse {
	...
	clientsRes, err := http.Get("https://api.furynet.finance/ibc/core/client/v1/client_states/" + clientID)
	if err != nil {
		panic(err)
	}
