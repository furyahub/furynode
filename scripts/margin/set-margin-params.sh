...
furynoded tx margin update-params \
  ...
  --force-close-fund-address=fury1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd \
  --incremental-interest-payment-enabled=true \
  --incremental-interest-payment-fund-percentage=0.1 \
  --incremental-interest-payment-fund-address=fury1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd \
