...
echo "crunch enable gauge equip sadness venture volcano capable boil pole lounge because service level giggle decide south deposit bike antique consider olympic girl butter" | furynd keys add alice --recover --keyring-backend=test

furynd keys add mkey --multisig fury,akasha --multisig-threshold 2 --keyring-backend=test

furynd add-genesis-account $(furynd keys show fury -a --keyring-backend=test) 500000000000000000000000000000000fury,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink,5000000000000cusdt,90000000000000000000ibc/96D7172B711F7F925DFC7579C6CCC3C80B762187215ABD082CDE99F81153DC80 --keyring-backend=test
...
furynd add-genesis-account $(furynd keys show alice -a --keyring-backend=test) 500000000000000000000000fury,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test
...
furynd gentx fury 1000000000000000000000000stake --moniker fury_val --chain-id=localnet --keyring-backend=test
