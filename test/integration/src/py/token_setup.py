...
from integration_env_credentials import create_new_furyaddr_and_credentials
from test_utilities import create_new_currency


# This file is for setting up an installation with a set of currencies given
# in a json file like ui/core/src/assets.furynet.mainnet.json.
#
# Run example:
#
#  TOKENS_FILE=$BASEDIR/ui/core/src/assets.furynet.mainnet.json python3 -m pytest src/py/token_setup.py

def build_request_for_new_furynet_address(basic_transfer_request, source_ethereum_address, new_currency, amount):
    furyaddress, credentials = create_new_furyaddr_and_credentials()
    ...
    request.furynet_symbol = "c" + new_currency["newtoken_symbol"]
    request.furynet_address = furyaddress
