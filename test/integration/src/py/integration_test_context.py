...
class IntegrationTestContext:
    ...
    @property
    def furynode_base_dir(self):
        return self.get_required_var("BASEDIR")

    @property
    def smart_contracts_dir(self):
        return self.get_optional_var("SMART_CONTRACTS_DIR", os.path.join(self.furynode_base_dir, "smart-contracts"))
    ...
    def ganache_keys_file(self):
        return self.get_optional_var("GANACHE_KEYS_FILE",
            os.path.join(self.furynode_base_dir, "test/integration/vagrant/data/ganachekeys.json"))
    ...
    def fury_source_integrationtest_env_transfer_request(self, basic_transfer_request):
        ...
        result.furynet_address = self.fury_source
