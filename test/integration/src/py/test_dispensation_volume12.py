...
def test_run_online_morethan10distribution_txn(claimType):
    ...
    destaddress10, destname10 = create_new_furyaddr_and_key()
    destaddress11, destname11 = create_new_furyaddr_and_key()
    destaddress12, destname12 = create_new_furyaddr_and_key()
