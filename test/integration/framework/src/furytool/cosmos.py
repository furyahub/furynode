...
# class/module.)
# Source: https://furynet.slack.com/archives/C01T05LPFEG/p1632822677353400?thread_ts=1632735716.332000&cid=C01T05LPFEG
...
def transfer(cmd, channel, address, amount, from_addr, chain_id, node, gas_prices, gas, packet_timeout_timestamp):
    ...
    # fury19q2swhcxkxlc6va3pz5jz42jfsfv2ly4kuu8y0
    ...
    # channel = "channel-66"
    # address = "fury19q2swhcxkxlc6va3pz5jz42jfsfv2ly4kuu8y0
