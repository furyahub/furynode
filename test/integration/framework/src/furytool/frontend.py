from furytool import command, project
from furytool.common import *

GIT_REPO_PROXIES = "git@github.com:Furynet/proxies.git"
GITHUB_REPO_UI = "https://github.com/Furynet/furynet-ui.git"
...
def run_local_ui(cmd: command.Command):
    ...
    ui_repo_dir = os.path.join(working_dir, "furynet-ui")
