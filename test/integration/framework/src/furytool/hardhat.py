import json
import web3
from furytool import eth, command
from furytool.command import Command, ExecResult, buildcmd
...
class ScriptRunner:
    ...
    # TODO This is called mostly from furytool and it's one line, convert to web3 call
    def update_validator_power(self, cosmos_bridge_addr, evm_validator_addresses, furynode_witnesses):
        npx_env = {
            "COSMOSBRIDGE": cosmos_bridge_addr,
            "POWERS": ",".join(str(x["power"]) for x in furynode_witnesses),
