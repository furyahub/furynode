...
```
make furydocker  # builds the docker image
make furydocker-start  # starts the docker container and leaves it running
make furydocker-sh     # gives you a shell in the running container
```
## Execute
...
This creates a new furynet account with 120000000000 tokens of each of the tokens in the whitelist.  
...
where FURY_SOURCE is a furynode address with sufficient tokens to distribute.
