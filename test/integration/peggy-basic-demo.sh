...
$(furynd keys show akasha -a) $(furynd keys show shadowfiend -a --bech val) 5 lock \
...
furynd q auth account $(furynd keys show akasha -a)
...
furynd tx ethbridge burn $(furynd keys show akasha -a) 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9 \
...
furynd tx ethbridge lock $(furynd keys show akasha -a) 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9 \
...
$(furynd keys show akasha -a) $(furynd keys show shadowfiend -a --bech val) \
