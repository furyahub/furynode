...
$(furynoded keys show akasha -a) $(furynoded keys show shadowfiend -a --bech val) 5 lock \
...
furynoded q auth account $(furynoded keys show akasha -a)
...
furynoded tx ethbridge burn $(furynoded keys show akasha -a) 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9 \
...
## Case 3
## 1. lock akasha rwn in furynet
furynoded tx ethbridge lock $(furynoded keys show akasha -a) 0x11111111262b236c9ac9a9a8c8e4276b5cf6b2c9 \
...
$(furynoded keys show akasha -a) $(furynoded keys show shadowfiend -a --bech val) \
