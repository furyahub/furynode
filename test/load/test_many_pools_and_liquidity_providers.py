...
#
# Scenario description: https://www.notion.so/furynet/Rewards-2-0-Load-Testing-972fbe73b04440cd87232aa60a3146c5
# Ticket: https://app.zenhub.com/workspaces/current-sprint---engineering-615a2e9fe2abd5001befc7f9/issues/furynet/furynode/3020
# How to run a validator in multi-node setup:
# - https://docs.furynet.finance/network-security/validators/running-furynode-and-becoming-a-validator
# - https://docs.furynet.finance/developers/tutorials/setup-standalone-validator-node-manually
#
# Requirements: Python (3.9 is best, 3.8 and 3.10 should also work, support for other versions is currently unknownn)
#
# Example usage:
# cd test/load
# ../integration/framework/furytool venv
...
# $ curl -i "http://rpc-archive.furynet.finance/block_results?height=9000000"
...
# }
#
# (2) use rocksb, see https://raw.githubusercontent.com/Furynet/furynet-devops/1218ff79b22ab2a6bd22b81d6aa4385a247cafc9/scripts/furynode/testing/furynode_n_node_network_simulator.py?token=GHSAT0AAAAAABLH7LII5AAWD6YDWG7THBHGYW7DSVA
#
...
from furytool import command, furynet, project, cosmos, environments, test_utils2
from furytool.furynet import FURY, STAKE, FURY_DECIMALS
...
class Test:
    def __init__(self, cmd: command.Command, prj: project.Project, furynoded_home_root: str):
        ...
        self.custom_wallet_mnemonics = [
            # fury1rruvw03utshn7ry3emeqf2gzkg6eap6hu5shun
    ...
    def run(self):
        ...
        # See https://www.notion.so/furynet/Rewards-2-0-Load-Testing-972fbe73b04440cd87232aa60a3146c5#7392be2c1a034d2db83b9b38ab89ff9e
