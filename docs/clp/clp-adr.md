# ADR 001: CLP integration with Furynode
...
For the Furynet MVP, CLP module provides the following functionalities 
...
PoolUnits : 1000
PoolAddress :fury1vdjxzumgtae8wmstpv9skzctpv9skzct72zwra
````
...
liquidityProviderAddress: fury15tyrwghfcjszj7sckxvqh0qpzprup9mhksmuzm 
````
...
## Decisions 
 ...
 - **Swap**
  ...
  ## References
 https://github.com/Furynet/furynode/blob/develop/docs/1.Liquidity%20Pools%20Architecture.md
