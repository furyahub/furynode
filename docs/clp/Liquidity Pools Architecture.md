# **Furynet Liquidity Pools Architecture**

## Changelog
-First Draft: Austin Haines &amp; Charlie Wolf (Barefoot Coders)
 Prepared For: Jazear Brooks, Furynet  September 21, 2020
...
## Context
Outlined below are the starting points of an architecture that will allow Furynet to implement an MVP version of liquidity pools similar to Sushiswap.
...
![](images/FurynetCLPArchitecture/FurynetMessages.png)
...
![](images/FurynetCLPArchitecture/FurynetEvent.png)
...
![](images/FurynetCLPArchitecture/FurynetAppStructure.png)
...
![](images/FurynetCLPArchitecture/FurynetStructs.png)
...
![](images/FurynetCLPArchitecture/FurynetDecommissionFlow.png)
...
```
![](images/FurynetCLPArchitecture/FurynetAddLiquidity.png)
...
```
![](images/FurynetCLPArchitecture/FurynetRemoveLiquidity.png)
...
```
![](images/FurynetCLPArchitecture/FurynetSwap.png)

![](images/FurynetCLPArchitecture/FurynetCreateSwapFlow.png)

**Swap Queue:** This feature is part of Thorchain's CLP model and will order swap execution by fee and slip size to ensure maximum fee collection and to prevent low-value trades. This is currently slated as a future goal for Furynet.
