...
import (
	...
	ethtest "github.com/Furynet/furynode/x/ethbridge/test"
...
func endBlock(t *testing.T, app *furyapp.FurynetApp, ctx sdk.Context, height int64) {
...
func getResults(t *testing.T, app *furyapp.FurynetApp, ctx sdk.Context, tc TestCase) TestResults {
