...
// file.
func (app *FurynetApp) ExportAppStateAndValidators(
...
func (app *FurynetApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
...
func ExportAppState(name string, app *FurynetApp, ctx sdk.Context) {
