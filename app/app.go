...
import (
	...
	furynetAnte "github.com/Furynet/furynode/app/ante"
	"github.com/Furynet/furynode/x/admin"
	adminkeeper "github.com/Furynet/furynode/x/admin/keeper"
	admintypes "github.com/Furynet/furynode/x/admin/types"
	"github.com/Furynet/furynode/x/clp"
	clpkeeper "github.com/Furynet/furynode/x/clp/keeper"
	clptypes "github.com/Furynet/furynode/x/clp/types"
	"github.com/Furynet/furynode/x/dispensation"
	dispkeeper "github.com/Furynet/furynode/x/dispensation/keeper"
	disptypes "github.com/Furynet/furynode/x/dispensation/types"
	"github.com/Furynet/furynode/x/ethbridge"
	ethbridgekeeper "github.com/Furynet/furynode/x/ethbridge/keeper"
	ethbridgetypes "github.com/Furynet/furynode/x/ethbridge/types"
	ibctransferoverride "github.com/Furynet/furynode/x/ibctransfer"
	sctransfertypes "github.com/Furynet/furynode/x/ibctransfer/types"
	"github.com/Furynet/furynode/x/margin"
	marginkeeper "github.com/Furynet/furynode/x/margin/keeper"
	margintypes "github.com/Furynet/furynode/x/margin/types"
	"github.com/Furynet/furynode/x/oracle"
	oraclekeeper "github.com/Furynet/furynode/x/oracle/keeper"
	oracletypes "github.com/Furynet/furynode/x/oracle/types"
	"github.com/Furynet/furynode/x/tokenregistry"
	tokenregistrykeeper "github.com/Furynet/furynode/x/tokenregistry/keeper"
	tokenregistrytypes "github.com/Furynet/furynode/x/tokenregistry/types"
...
var (
	_ simapp.App              = (*FurynetApp)(nil)
	_ servertypes.Application = (*FurynetApp)(nil)
)

type FurynetApp struct {
	*baseapp.BaseApp
...
func NewFuryApp(
	...
	return NewFuryAppWithBlacklist(logger, db, traceStore, loadLatest, skipUpgradeHeights, homePath, invCheckPeriod, encodingConfig, appOpts, []sdk.AccAddress{}, baseAppOptions...)
}

func NewFuryAppWithBlacklist(
	logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool, skipUpgradeHeights map[int64]bool,
	homePath string, invCheckPeriod uint, encodingConfig simappparams.EncodingConfig,
	...
	*/
	...
	anteHandler, err := furynetAnte.NewAnteHandler(
		furynetAnte.HandlerOptions{
...
func (app *FurynetApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *FurynetApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

func (app *FurynetApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

func (app *FurynetApp) LegacyAmino() *codec.LegacyAmino { //nolint
...
func (app *FurynetApp) AppCodec() codec.Codec {
	return app.appCodec
}
...
func (app *FurynetApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

func (app *FurynetApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *FurynetApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *FurynetApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// LoadHeight loads a particular height
func (app *FurynetApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *FurynetApp) ModuleAccountAddrs() map[string]bool {
...
func (app *FurynetApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
// API server.
func (app *FurynetApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *FurynetApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *FurynetApp) RegisterTendermintService(clientCtx client.Context) {
