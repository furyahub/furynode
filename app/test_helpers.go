...
func setup(withGenesis bool, invCheckPeriod uint, blacklist []sdk.AccAddress) (*FurynetApp, GenesisState) {
	db := dbm.NewMemDB()
	encCdc := MakeTestEncodingConfig()
	app := NewFuryAppWithBlacklist(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, invCheckPeriod, encCdc, EmptyAppOptions{}, blacklist)
	if withGenesis {
...
func Setup(isCheckTx bool) *FurynetApp {
	return SetupWithBlacklist(isCheckTx, []sdk.AccAddress{})
}

// Setup initializes a new SimApp. A Nop logger is set in SimApp.
func SetupWithBlacklist(isCheckTx bool, blacklist []sdk.AccAddress) *FurynetApp {
...
func SetupFromGenesis(isCheckTx bool, genesisTransformer func(*FurynetApp, GenesisState) GenesisState) *FurynetApp {
...
func AddTestAddrs(app *FurynetApp, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, CreateRandomAccounts)
}

func addTestAddrs(app *FurynetApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
