...
// source: furynode/admin/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgAddAccount)(nil), "furynode.admin.v1.MsgAddAccount")
	proto.RegisterType((*MsgAddAccountResponse)(nil), "furynode.admin.v1.MsgAddAccountResponse")
	proto.RegisterType((*MsgRemoveAccount)(nil), "furynode.admin.v1.MsgRemoveAccount")
	proto.RegisterType((*MsgRemoveAccountResponse)(nil), "furynode.admin.v1.MsgRemoveAccountResponse")
	proto.RegisterType((*MsgSetParams)(nil), "furynode.admin.v1.MsgSetParams")
	proto.RegisterType((*MsgSetParamsResponse)(nil), "furynode.admin.v1.MsgSetParamsResponse")
}

func init() { proto.RegisterFile("furynode/admin/v1/tx.proto", fileDescriptor_600acd904f18192e) }
...
func (c *msgClient) AddAccount(ctx context.Context, in *MsgAddAccount, opts ...grpc.CallOption) (*MsgAddAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.admin.v1.Msg/AddAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveAccount(ctx context.Context, in *MsgRemoveAccount, opts ...grpc.CallOption) (*MsgRemoveAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.admin.v1.Msg/RemoveAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetParams(ctx context.Context, in *MsgSetParams, opts ...grpc.CallOption) (*MsgSetParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.admin.v1.Msg/SetParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.admin.v1.Msg/AddAccount",
	}
...
func _Msg_RemoveAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.admin.v1.Msg/RemoveAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.admin.v1.Msg/SetParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.admin.v1.Msg",
	...
	Metadata: "furynode/admin/v1/tx.proto",
}
