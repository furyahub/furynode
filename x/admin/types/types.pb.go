...
// source: furynode/admin/v1/types.proto
...
type AdminAccount struct {
	AdminType    AdminType `protobuf:"varint,1,opt,name=admin_type,json=adminType,proto3,enum=furynode.admin.v1.AdminType" json:"admin_type,omitempty"`
...
func init() {
	proto.RegisterEnum("furynode.admin.v1.AdminType", AdminType_name, AdminType_value)
	proto.RegisterType((*GenesisState)(nil), "furynode.admin.v1.GenesisState")
	proto.RegisterType((*AdminAccount)(nil), "furynode.admin.v1.AdminAccount")
	proto.RegisterType((*Params)(nil), "furynode.admin.v1.Params")
}

func init() { proto.RegisterFile("furynode/admin/v1/types.proto", fileDescriptor_97192799444a7295) }
