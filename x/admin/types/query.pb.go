...
// source: furynode/admin/v1/query.proto
...
func init() {
	proto.RegisterType((*ListAccountsRequest)(nil), "furynode.admin.v1.ListAccountsRequest")
	proto.RegisterType((*ListAccountsResponse)(nil), "furynode.admin.v1.ListAccountsResponse")
	proto.RegisterType((*GetParamsRequest)(nil), "furynode.admin.v1.GetParamsRequest")
	proto.RegisterType((*GetParamsResponse)(nil), "furynode.admin.v1.GetParamsResponse")
}

func init() { proto.RegisterFile("furynode/admin/v1/query.proto", fileDescriptor_3e062bad86f8e9de) }
...
func (c *queryClient) ListAccounts(ctx context.Context, in *ListAccountsRequest, opts ...grpc.CallOption) (*ListAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.admin.v1.Query/ListAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetParams(ctx context.Context, in *GetParamsRequest, opts ...grpc.CallOption) (*GetParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.admin.v1.Query/GetParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ListAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.admin.v1.Query/ListAccounts",
	}
...
func _Query_GetParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.admin.v1.Query/GetParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.admin.v1.Query",
	...
	Metadata: "furynode/admin/v1/query.proto",
}
