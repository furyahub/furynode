...
// source: furynode/oracle/v1/types.proto
...
type Status struct {
	Text       StatusText `protobuf:"varint,1,opt,name=text,proto3,enum=furynode.oracle.v1.StatusText" json:"text,omitempty"`
...
func init() {
	proto.RegisterEnum("furynode.oracle.v1.StatusText", StatusText_name, StatusText_value)
	proto.RegisterType((*GenesisState)(nil), "furynode.oracle.v1.GenesisState")
	proto.RegisterType((*Claim)(nil), "furynode.oracle.v1.Claim")
	proto.RegisterType((*DBProphecy)(nil), "furynode.oracle.v1.DBProphecy")
	proto.RegisterType((*Status)(nil), "furynode.oracle.v1.Status")
}

func init() { proto.RegisterFile("furynode/oracle/v1/types.proto", fileDescriptor_dac1b931484f4203) }
