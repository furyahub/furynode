...
func (prophecy Prophecy) FindHighestClaim(ctx sdk.Context, stakeKeeper StakingKeeper, whiteListValidatorAddresses []sdk.ValAddress) (string, int64, int64, int64) {
	fmt.Println("furynode oracle prophecy FindHighestClaim")
	validators := stakeKeeper.GetBondedValidatorsByPower(ctx)
	fmt.Printf("furynode oracle prophecy FindHighestClaim validators length is %d\n", len(validators))
	...
	fmt.Printf("furynode oracle prophecy FindHighestClaim totalPower is %d\n", totalPower)
	...
	for claim, validatorAddrs := range prophecy.ClaimValidators {
		...
		for _, validatorAddr := range validatorAddrs {
			fmt.Printf("furynode oracle prophecy FindHighestClaim validator is %s\n", validatorAddr.String())
		...
		fmt.Printf("furynode oracle prophecy FindHighestClaim totalClaimsPower is %d\n", totalClaimsPower)
		fmt.Printf("furynode oracle prophecy FindHighestClaim claimPower is %d\n", claimPower)
