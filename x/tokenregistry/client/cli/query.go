...
import (
	...
	whitelistutils "github.com/Furynet/furynode/x/tokenregistry/utils"
)
...
func GetCmdGenerateEntry() *cobra.Command {
	...
	cmd.Flags().String(flagDenom, "",
		"The IBC hash / denom  stored on furynet - to generate this hash for IBC token, leave blank and specify base_denom and ibc_channel_id")
