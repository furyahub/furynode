...
// source: furynode/tokenregistry/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegister)(nil), "furynode.tokenregistry.v1.MsgRegister")
	proto.RegisterType((*MsgRegisterResponse)(nil), "furynode.tokenregistry.v1.MsgRegisterResponse")
	proto.RegisterType((*MsgSetRegistry)(nil), "furynode.tokenregistry.v1.MsgSetRegistry")
	proto.RegisterType((*MsgSetRegistryResponse)(nil), "furynode.tokenregistry.v1.MsgSetRegistryResponse")
	proto.RegisterType((*MsgDeregister)(nil), "furynode.tokenregistry.v1.MsgDeregister")
	proto.RegisterType((*MsgDeregisterResponse)(nil), "furynode.tokenregistry.v1.MsgDeregisterResponse")
}

func init() { proto.RegisterFile("furynode/tokenregistry/v1/tx.proto", fileDescriptor_d09312f3deb69cfe) }
...
func (c *msgClient) Register(ctx context.Context, in *MsgRegister, opts ...grpc.CallOption) (*MsgRegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.tokenregistry.v1.Msg/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Deregister(ctx context.Context, in *MsgDeregister, opts ...grpc.CallOption) (*MsgDeregisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.tokenregistry.v1.Msg/Deregister", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetRegistry(ctx context.Context, in *MsgSetRegistry, opts ...grpc.CallOption) (*MsgSetRegistryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.tokenregistry.v1.Msg/SetRegistry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.tokenregistry.v1.Msg/Register",
	}
...
func _Msg_Deregister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.tokenregistry.v1.Msg/Deregister",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetRegistry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.tokenregistry.v1.Msg/SetRegistry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.tokenregistry.v1.Msg",
	...
	Metadata: "furynode/tokenregistry/v1/tx.proto",
}
