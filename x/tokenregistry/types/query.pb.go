...
// source: furynode/tokenregistry/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryEntriesResponse)(nil), "furynode.tokenregistry.v1.QueryEntriesResponse")
	proto.RegisterType((*QueryEntriesRequest)(nil), "furynode.tokenregistry.v1.QueryEntriesRequest")
}

func init() {
	proto.RegisterFile("furynode/tokenregistry/v1/query.proto", fileDescriptor_c311bc06126a6f47)
}
...
func (c *queryClient) Entries(ctx context.Context, in *QueryEntriesRequest, opts ...grpc.CallOption) (*QueryEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.tokenregistry.v1.Query/Entries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Entries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.tokenregistry.v1.Query/Entries",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.tokenregistry.v1.Query",
	...
	Metadata: "furynode/tokenregistry/v1/query.proto",
}
