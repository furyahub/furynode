...
// source: furynode/dispensation/v1/types.proto
...
type DistributionRecord struct {
	DistributionStatus          DistributionStatus                       `protobuf:"varint,1,opt,name=distribution_status,json=distributionStatus,proto3,enum=furynode.dispensation.v1.DistributionStatus" json:"distribution_status,omitempty"`
	DistributionType            DistributionType                         `protobuf:"varint,2,opt,name=distribution_type,json=distributionType,proto3,enum=furynode.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
type Distribution struct {
	DistributionType DistributionType `protobuf:"varint,1,opt,name=distribution_type,json=distributionType,proto3,enum=furynode.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
type UserClaim struct {
	...
	UserClaimType DistributionType                          `protobuf:"varint,2,opt,name=user_claim_type,json=userClaimType,proto3,enum=furynode.dispensation.v1.DistributionType" json:"user_claim_type,omitempty"`
...
func init() {
	proto.RegisterEnum("furynode.dispensation.v1.DistributionType", DistributionType_name, DistributionType_value)
	proto.RegisterEnum("furynode.dispensation.v1.DistributionStatus", DistributionStatus_name, DistributionStatus_value)
	proto.RegisterType((*GenesisState)(nil), "furynode.dispensation.v1.GenesisState")
	proto.RegisterType((*DistributionRecord)(nil), "furynode.dispensation.v1.DistributionRecord")
	proto.RegisterType((*DistributionRecords)(nil), "furynode.dispensation.v1.DistributionRecords")
	proto.RegisterType((*Distributions)(nil), "furynode.dispensation.v1.Distributions")
	proto.RegisterType((*Distribution)(nil), "furynode.dispensation.v1.Distribution")
	proto.RegisterType((*UserClaim)(nil), "furynode.dispensation.v1.UserClaim")
	proto.RegisterType((*UserClaims)(nil), "furynode.dispensation.v1.UserClaims")
	proto.RegisterType((*MintController)(nil), "furynode.dispensation.v1.MintController")
}

func init() {
	proto.RegisterFile("furynode/dispensation/v1/types.proto", fileDescriptor_bfdf912039cd8799)
}
