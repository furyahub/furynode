...
// source: furynode/dispensation/v1/tx.proto
...
type MsgCreateDistribution struct {
	...
	DistributionType DistributionType                                   `protobuf:"varint,3,opt,name=distribution_type,json=distributionType,proto3,enum=furynode.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
func init() {
	proto.RegisterType((*MsgCreateDistribution)(nil), "furynode.dispensation.v1.MsgCreateDistribution")
	proto.RegisterType((*MsgCreateDistributionResponse)(nil), "furynode.dispensation.v1.MsgCreateDistributionResponse")
	proto.RegisterType((*MsgCreateClaimResponse)(nil), "furynode.dispensation.v1.MsgCreateClaimResponse")
	proto.RegisterType((*MsgRunDistributionResponse)(nil), "furynode.dispensation.v1.MsgRunDistributionResponse")
	proto.RegisterType((*MsgCreateUserClaim)(nil), "furynode.dispensation.v1.MsgCreateUserClaim")
	proto.RegisterType((*MsgRunDistribution)(nil), "furynode.dispensation.v1.MsgRunDistribution")
}

func init() { proto.RegisterFile("furynode/dispensation/v1/tx.proto", fileDescriptor_eb59f4566305e810) }
...
func (c *msgClient) CreateDistribution(ctx context.Context, in *MsgCreateDistribution, opts ...grpc.CallOption) (*MsgCreateDistributionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Msg/CreateDistribution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateUserClaim(ctx context.Context, in *MsgCreateUserClaim, opts ...grpc.CallOption) (*MsgCreateClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Msg/CreateUserClaim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RunDistribution(ctx context.Context, in *MsgRunDistribution, opts ...grpc.CallOption) (*MsgRunDistributionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Msg/RunDistribution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateDistribution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Msg/CreateDistribution",
	}
...
func _Msg_CreateUserClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Msg/CreateUserClaim",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RunDistribution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Msg/RunDistribution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.dispensation.v1.Msg",
	...
	Metadata: "furynode/dispensation/v1/tx.proto",
}
