...
// source: furynode/dispensation/v1/query.proto
...
type QueryRecordsByDistributionNameRequest struct {
	...
	Status           DistributionStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furynode.dispensation.v1.DistributionStatus" json:"status,omitempty"`
}
...
type QueryClaimsByTypeRequest struct {
	UserClaimType DistributionType `protobuf:"varint,1,opt,name=user_claim_type,json=userClaimType,proto3,enum=furynode.dispensation.v1.DistributionType" json:"user_claim_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*QueryAllDistributionsRequest)(nil), "furynode.dispensation.v1.QueryAllDistributionsRequest")
	proto.RegisterType((*QueryAllDistributionsResponse)(nil), "furynode.dispensation.v1.QueryAllDistributionsResponse")
	proto.RegisterType((*QueryRecordsByDistributionNameRequest)(nil), "furynode.dispensation.v1.QueryRecordsByDistributionNameRequest")
	proto.RegisterType((*QueryRecordsByDistributionNameResponse)(nil), "furynode.dispensation.v1.QueryRecordsByDistributionNameResponse")
	proto.RegisterType((*QueryRecordsByRecipientAddrRequest)(nil), "furynode.dispensation.v1.QueryRecordsByRecipientAddrRequest")
	proto.RegisterType((*QueryRecordsByRecipientAddrResponse)(nil), "furynode.dispensation.v1.QueryRecordsByRecipientAddrResponse")
	proto.RegisterType((*QueryClaimsByTypeRequest)(nil), "furynode.dispensation.v1.QueryClaimsByTypeRequest")
	proto.RegisterType((*QueryClaimsResponse)(nil), "furynode.dispensation.v1.QueryClaimsResponse")
}

func init() {
	proto.RegisterFile("furynode/dispensation/v1/query.proto", fileDescriptor_395b1a3b0bf5b135)
}
...
func (c *queryClient) AllDistributions(ctx context.Context, in *QueryAllDistributionsRequest, opts ...grpc.CallOption) (*QueryAllDistributionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Query/AllDistributions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RecordsByDistributionName(ctx context.Context, in *QueryRecordsByDistributionNameRequest, opts ...grpc.CallOption) (*QueryRecordsByDistributionNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Query/RecordsByDistributionName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RecordsByRecipient(ctx context.Context, in *QueryRecordsByRecipientAddrRequest, opts ...grpc.CallOption) (*QueryRecordsByRecipientAddrResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Query/RecordsByRecipient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimsByType(ctx context.Context, in *QueryClaimsByTypeRequest, opts ...grpc.CallOption) (*QueryClaimsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.dispensation.v1.Query/ClaimsByType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_AllDistributions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Query/AllDistributions",
	}
...
func _Query_RecordsByDistributionName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Query/RecordsByDistributionName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_RecordsByRecipient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Query/RecordsByRecipient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimsByType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.dispensation.v1.Query/ClaimsByType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.dispensation.v1.Query",
	...
	Metadata: "furynode/dispensation/v1/query.proto",
}
