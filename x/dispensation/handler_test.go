...
import (
	...
	dispensationUtils "github.com/Furynet/furynode/x/dispensation/utils"
...
func TestNewHandler_CreateDistribution(t *testing.T) {
	...
	err = furyapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, distributor, totalCoins)
	assert.NoError(t, err)
