...
import (
	"encoding/json"
	"github.com/Furynet/furynode/x/ethbridge/utils"
	"io/ioutil"
	"path/filepath"
	"regexp"
	"strconv"
...
// GetCmdUpdateCethReceiverAccount is the CLI command to update the furynet account that receives the ceth proceeds
