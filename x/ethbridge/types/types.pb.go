...
// source: furynode/ethbridge/v1/types.proto
...
type EthBridgeClaim struct {
	...
	ClaimType        ClaimType                              `protobuf:"varint,10,opt,name=claim_type,json=claimType,proto3,enum=furynode.ethbridge.v1.ClaimType" json:"claim_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furynode.ethbridge.v1.ClaimType", ClaimType_name, ClaimType_value)
	proto.RegisterType((*EthBridgeClaim)(nil), "furynode.ethbridge.v1.EthBridgeClaim")
	proto.RegisterType((*PeggyTokens)(nil), "furynode.ethbridge.v1.PeggyTokens")
	proto.RegisterType((*GenesisState)(nil), "furynode.ethbridge.v1.GenesisState")
	proto.RegisterType((*Pause)(nil), "furynode.ethbridge.v1.Pause")
}

func init() { proto.RegisterFile("furynode/ethbridge/v1/types.proto", fileDescriptor_4cb34f678c9ed59f) }
