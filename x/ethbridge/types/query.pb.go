...
// source: furynode/ethbridge/v1/query.proto
...
import (
	context "context"
	fmt "fmt"
	types "github.com/Furynet/furynode/x/oracle/types"
...
func init() {
	proto.RegisterType((*QueryEthProphecyRequest)(nil), "furynode.ethbridge.v1.QueryEthProphecyRequest")
	proto.RegisterType((*QueryEthProphecyResponse)(nil), "furynode.ethbridge.v1.QueryEthProphecyResponse")
	proto.RegisterType((*QueryBlacklistRequest)(nil), "furynode.ethbridge.v1.QueryBlacklistRequest")
	proto.RegisterType((*QueryBlacklistResponse)(nil), "furynode.ethbridge.v1.QueryBlacklistResponse")
	proto.RegisterType((*QueryPauseRequest)(nil), "furynode.ethbridge.v1.QueryPauseRequest")
	proto.RegisterType((*QueryPauseResponse)(nil), "furynode.ethbridge.v1.QueryPauseResponse")
}

func init() { proto.RegisterFile("furynode/ethbridge/v1/query.proto", fileDescriptor_7077edcf9f792b78) }
...
func (c *queryClient) EthProphecy(ctx context.Context, in *QueryEthProphecyRequest, opts ...grpc.CallOption) (*QueryEthProphecyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.ethbridge.v1.Query/EthProphecy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetBlacklist(ctx context.Context, in *QueryBlacklistRequest, opts ...grpc.CallOption) (*QueryBlacklistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.ethbridge.v1.Query/GetBlacklist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetPauseStatus(ctx context.Context, in *QueryPauseRequest, opts ...grpc.CallOption) (*QueryPauseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynode.ethbridge.v1.Query/GetPauseStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EthProphecy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.ethbridge.v1.Query/EthProphecy",
	}
...
func _Query_GetBlacklist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.ethbridge.v1.Query/GetBlacklist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetPauseStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynode.ethbridge.v1.Query/GetPauseStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynode.ethbridge.v1.Query",
	...
	Metadata: "furynode/ethbridge/v1/query.proto",
}
