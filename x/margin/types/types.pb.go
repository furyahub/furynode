...
// source: furynode/margin/v1/types.proto
...
type MTP struct {
	...
	Position                 Position                                `protobuf:"varint,12,opt,name=position,proto3,enum=furynode.margin.v1.Position" json:"position,omitempty"`
...
func init() {
	proto.RegisterEnum("furynode.margin.v1.Position", Position_name, Position_value)
	proto.RegisterType((*GenesisState)(nil), "furynode.margin.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "furynode.margin.v1.Params")
	proto.RegisterType((*MTP)(nil), "furynode.margin.v1.MTP")
}

func init() { proto.RegisterFile("furynode/margin/v1/types.proto", fileDescriptor_b3994728d56e8650) }
