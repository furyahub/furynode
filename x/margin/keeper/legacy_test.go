...
func TestKeeper_NewLegacyHandler(t *testing.T) {
	...
	marginKeeper.WhitelistAddress(ctx, "fury1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd")
	...
	var (
		msgOpen       sdk.Msg = &types.MsgOpen{Signer: "fury1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd"}
