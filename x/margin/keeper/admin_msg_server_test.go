...
func TestMsgServer_AdminCloseAll(t *testing.T) {
	table := []struct {
	...
	}{
		{
			...
			msgAdminCloseAll: types.MsgAdminCloseAll{Signer: "fury1azpar20ck9lpys89r8x7zc8yu0qzgvtp48ng5v", TakeMarginFund: true},
			msgOpen: types.MsgOpen{
		...
		},
		{
			...
			msgAdminCloseAll: types.MsgAdminCloseAll{Signer: "fury1azpar20ck9lpys89r8x7zc8yu0qzgvtp48ng5v", TakeMarginFund: false},
			msgOpen: types.MsgOpen{
				CollateralAsset: "fury",
				BorrowAsset:     "xxx",
				Position:        types.Position_LONG,
