...
import (
	...
	"github.com/Furynet/furynode/x/margin/client/cli"
...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	// 	db := dbm.NewMemDB()
	// 	return furyapp.NewFuryApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, val.Dir, 0, encConfig, furyapp.EmptyAppOptions{})
	// }
