...
func TestKeeper_CreatePool_Error(t *testing.T) {
	...
	_ = furyapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin, nativeCoin))
...
func TestKeeper_CreatePool_And_AddLiquidity_RemoveLiquidity(t *testing.T) {
	...
	assert.Equal(t, lp.LiquidityProviderAddress, "fury15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqhns3lt")
...
func TestKeeper_CreateLiquidityProvider(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, lp.LiquidityProviderAddress, "fury1azpar20ck9lpys89r8x7zc8yu0qzgvtp48ng5v")
}
...
func TestKeeper_FinalizeSwap(t *testing.T) {
	...
	_ = furyapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin1, nativeCoin))
	_ = furyapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin2, nativeCoin))
