...
import (
	...
	"github.com/Furynet/furynode/x/clp/test"
...
func TestCreatePool(t *testing.T) {
	...
	err := furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin, nativeCoin))
	...
	err = furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, signer, sdk.Coins{newAssetCoin}.Sort())
	require.NoError(t, err)
	// Create Pool
...
func TestAddLiquidity(t *testing.T) {
	...
	err = furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, signer2, sdk.NewCoins(externalCoin, nativeCoin))
	require.NoError(t, err)
...
func TestRemoveLiquidity(t *testing.T) {
	...
	err := furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin, nativeCoin))
	require.NoError(t, err)
	err = furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, newLP, sdk.NewCoins(externalCoin, nativeCoin))
	require.NoError(t, err)
...
func TestSwap(t *testing.T) {
	...
	err := furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin1, nativeCoin))
	require.NoError(t, err)
	err = furyapp.AddCoinsToAccount(clptypes.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin2))
	require.NoError(t, err)
...
func UnlockAllliquidity(app *furyapp.FurynetApp, ctx sdk.Context, asset clptypes.Asset, lp sdk.AccAddress, t *testing.T) {
