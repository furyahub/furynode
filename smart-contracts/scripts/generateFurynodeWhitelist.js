 ...
 *
 * Finally, run
 * $ npx hardhat run scripts/generateFurynodeWhitelist.js --network mainnet
 */
...
const furynodeDS = require("../data/ds_furynode_whitelist.json");
...
async function main() {
  ...
  for (let i = 0; i < addressList.length; i++) {
    try {
      ...
      const obj = _.cloneDeep(furynodeDS);
