...
import {setupRopstenDeployment, setupFurynetMainnetDeployment} from "../src/hardhatFunctions";
...
// DEPLOYMENT_NAME="furynet-testnet-042-ibc"
...
async function main() {
    ...
    const factories = await container.resolve(FurynetContractFactories) as FurynetContractFactories
