...
export async function setupDeployment(c: DependencyContainer) {
    ...
    switch(deploymentName) {
        case "furynet":
        case "furynet-1":
            setupFurynetMainnetDeployment(c, hre, deploymentName)
            break
        case undefined:
            break
        default:
...
export async function setupFurynetMainnetDeployment(c: DependencyContainer, hre: HardhatRuntimeEnvironment, deploymentName: "furynet" | "furynet-1") {
