...
import (
	...
	ebrelayertypes "github.com/Furynet/furynode/cmd/ebrelayer/types"
	flag "github.com/spf13/pflag"

	furyapp "github.com/Furynet/furynode/app"
	"github.com/Furynet/furynode/cmd/ebrelayer/contract"
	"github.com/Furynet/furynode/cmd/ebrelayer/relayer"
...
func buildRootCmd() *cobra.Command {
	...
	initClientCtx := client.Context{}.
		...
		WithHomeDir(furyapp.DefaultNodeHome)
	...
	rootCmd.PersistentFlags().String(
		...
		"",
		"Path to a json file containing an array of furynet denom => Ethereum symbol pairs",
	)
	rootCmd.PersistentFlags().String(
...
func replayEthereumCmd() *cobra.Command {
	...
	replayEthereumCmd := &cobra.Command{
		Use:     "replayEthereum [tendermintNode] [web3Provider] [bridgeRegistryContractAddress] [validatorMoniker] [validatorMnemonic] [fromBlock] [toBlock] [furyFromBlock] [furyEndBlock]",
...
func main() {
	if err := svrcmd.Execute(buildRootCmd(), furyapp.DefaultNodeHome); err != nil {
		switch e := err.(type) {
